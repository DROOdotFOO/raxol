...
| `harness-cohort-research.md` | Phase 1–2 (frame + priors) for the first cohort-research round, written before research returned. |
| `harness-research/` | Raw per-topic research briefs (01–09, plus later additions) underlying `harness-facts-two-perspectives.md` and `harness-synthesis.md`. |
