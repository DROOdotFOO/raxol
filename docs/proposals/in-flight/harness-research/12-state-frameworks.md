...
From ["I feel bad for anyone who got sucked into event sourcing for general purpose apps"](https://news.ycombinator.com/item?id=28702432): *"the technical costs you incur when you attempt to store events instead of tabular data are tremendous"* — verdict: *"don't do it!"* for general apps.
