defmodule Raxol.ACP.Secret do
  ...
  paths print `#Raxol.ACP.Secret<redacted>` instead of the key. The bytes are
  ...
  defimpl Inspect do
    def inspect(_secret, _opts), do: "#Raxol.ACP.Secret<redacted>"
  end
end
