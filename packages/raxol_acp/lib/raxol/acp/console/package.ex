defmodule Raxol.ACP.Console.Package do
  @moduledoc """
  Parse a Console agent package -- the inverse of `Raxol.ACP.Console.Generator`.
  ...
  Cron fields are re-validated with `Raxol.ACP.Console.Cron`, and skill paths
