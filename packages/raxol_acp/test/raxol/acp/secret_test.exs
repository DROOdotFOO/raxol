defmodule Raxol.ACP.SecretTest do
  @moduledoc """
  Offline (no network, no anvil) tests for `Raxol.ACP.Secret` and for the
  ...
  describe "redaction" do
    test "inspect/1 of a secret never exposes the bytes" do
      ...
      assert out == "#Raxol.ACP.Secret<redacted>"
