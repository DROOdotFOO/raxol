...
config :raxol_earn,
  seller_enabled: true,
  offerings: [Raxol.Earn.Console.AgentOffering],
...
#
#   config :raxol_earn,
#     seller_provider_adapter: Raxol.Earn.ProviderAdapter.SCA.new(...),
...
config :raxol_earn,
  ...
  console_artifact_store: [
    ...
    dir: "/var/lib/raxol_earn/console_artifacts",
...
# `Raxol.Earn.Chain` config. Sepolia defaults to canonical Circle USDC
