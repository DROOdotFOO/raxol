defmodule Raxol.Earn.Wallet.SCA.BundlerHarnessTest do
  @moduledoc """
  ...
  alias Raxol.Earn.Wallet.SCA.{ModularAccount, Provisioning, UserOp}
  ...
  defmodule Account do
    ...
    use Raxol.Earn.Wallet.SCA,
      ...
      chain_id: 8453,
      signer: Raxol.Earn.Wallet.SCA.BundlerHarnessTest.SessionKey,
      signer_entity_id: 0,
  ...
  test "session-key (entity 1) UserOp after owner deploy + installValidation", %{rpc: rpc} do
    ...
    install_data =
      Raxol.Earn.Wallet.SCA.Provisioning.install_session_key_calldata(@session_addr, 1)
    ...
    {:ok, session_sig} = Raxol.Earn.Wallet.SCA.sign_user_op_hash(session_hash, SessionSigner)
