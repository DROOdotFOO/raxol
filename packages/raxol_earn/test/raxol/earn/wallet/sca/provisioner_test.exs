defmodule Raxol.Earn.Wallet.SCA.ProvisionerTest do
  @moduledoc """
  ...
  alias Raxol.Earn.Wallet.SCA.{ModularAccount, Provisioner}
  ...
  defmodule SCAWallet do
    use Raxol.Earn.Wallet.SCA,
      ...
      chain_id: 8453,
      signer: Raxol.Earn.Wallet.SCA.ProvisionerTest.SessionKey,
      signer_entity_id: 1,
  ...
  defp install_stub(events, opts) do
    ...
    Application.put_env(:raxol_earn, :rpc, url: "http://stub.invalid/rpc", plug: plug)
