defmodule Raxol.Earn.Wallet.Sma7702Test do
  ...
  # Mock managed-authority provider: a Raxol.Earn.ProviderAdapter shape that records the
  ...
  defmodule MockProvider do
    ...
    def sign_typed_data(%{config: %{test_pid: pid}}, chain_id, typed_data) do
      ...
      {:ok, Raxol.Earn.Wallet.Sma7702Test.raw_sig()}
    end
  end
  ...
  defmodule Wallet do
    use Raxol.Earn.Wallet.Sma7702,
      ...
      chain_id: 8453,
      provider: {Raxol.Earn.Wallet.Sma7702Test, :provider}
  end
