defmodule Raxol.Earn.HookClientLiveTest do
  @moduledoc """
  Real-endpoint tests for `Raxol.Earn.HookClient` against an anvil fork
  ...
  alias Raxol.Earn.{ABI, HookClient, ProviderAdapter}
