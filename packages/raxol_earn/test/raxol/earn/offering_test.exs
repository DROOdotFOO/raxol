defmodule Raxol.Earn.OfferingTest do
  use ExUnit.Case, async: true

  alias Raxol.Earn.Offering
  alias Raxol.Earn.TestSupport.{EchoOffering, MinimalOffering}

  describe "use Raxol.Earn.Offering DSL: metadata accessors" do
