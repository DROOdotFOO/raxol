defmodule Raxol.Earn.Buyer.ResyncTest do
  use ExUnit.Case, async: false

  alias Raxol.Earn.Buyer.{Queue, Resync}
  ...
  alias Raxol.Earn.JobApi.Mock, as: JobApiMock
  ...
  defp put_all(map) do
    ...
    on_exit(fn -> Enum.each(Map.keys(map), &Application.delete_env(:raxol_earn, &1)) end)
  end
