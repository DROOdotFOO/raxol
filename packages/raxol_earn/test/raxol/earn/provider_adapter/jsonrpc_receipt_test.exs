defmodule Raxol.Earn.ProviderAdapter.JsonrpcReceiptTest do
  @moduledoc """
  Hermetic proof that `Raxol.Earn.ProviderAdapter.JSONRPC.send_calls/3`
  ...
  RPC is stubbed via a `:plug` (picked up from the `:raxol_earn, :rpc` app
