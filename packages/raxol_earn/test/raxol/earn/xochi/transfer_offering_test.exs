defmodule Raxol.Earn.Xochi.TransferOfferingTest do
  # async: false -- the deliver tests set/clear :xochi_transfer_settler app env.
  use ExUnit.Case, async: false

  alias Raxol.Earn.Xochi.{Offering, TransferOffering}
  ...
  describe "use Raxol.Earn.Offering DSL" do
  ...
  describe "handle_request/2 stablecoin corridor scope (allowlist enabled)" do
    setup do
      ...
      on_exit(fn -> Application.delete_env(:raxol_earn, :stablecoin_corridors_only) end)
      :ok
    end
