defmodule Raxol.Earn.Xochi.UsdcPublicOfferingTest do
  use ExUnit.Case, async: false

  alias Raxol.Earn.Xochi.{TransferCore, UsdcPublicOffering}
  ...
  describe "handle_request/2" do
    ...
    test "honors configured order-band overrides" do
      Application.put_env(:raxol_earn, :usdc_public_min_atomic, 2_000_000)
      on_exit(fn -> Application.delete_env(:raxol_earn, :usdc_public_min_atomic) end)
