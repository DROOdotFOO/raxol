defmodule Raxol.Earn.Xochi.SolverFeeLiveTest do
  @moduledoc """
  ...
  What is real here:
    ...
    * the real `Raxol.Earn.Xochi.SolverAgent` runs its production path
  ...
  if System.get_env("XOCHI_ORDER_LIVE_URL") && System.get_env("XOCHI_ORDER_LIVE_KEY") do
    alias Raxol.Earn.{Agent, Chain, JobApi, ProviderAdapter, Transport}
