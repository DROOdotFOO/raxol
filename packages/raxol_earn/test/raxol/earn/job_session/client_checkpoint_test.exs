defmodule Raxol.Earn.JobSession.ClientCheckpointTest do
  @moduledoc """
  ...
  @create_selector Raxol.Earn.ABI.encode_call(
                     "createJob(address,address,uint256,string,address)",
                     []
                   )
  @fund_selector Raxol.Earn.ABI.encode_call("fund(uint256,uint256,bytes)", [])
  ...
  test "a `creating` record reconciles by tag instead of double-creating", ctx do
    ...
    key = Raxol.Earn.Checkpoint.buyer_key(@chain, @rk)
