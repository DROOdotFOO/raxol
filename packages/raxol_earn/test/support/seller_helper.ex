defmodule Raxol.Earn.TestSupport.SellerHelper do
  @moduledoc """
  ...
  - Terminate any leftover `Raxol.Earn.JobSession` children from prior
  ...
  def reset_seller(opts \\ []) do
    ...
    Application.put_env(:raxol_earn, :seller_address, Keyword.get(opts, :seller_address))
