defmodule Raxol.Earn.Test.AnvilHarness do
  @moduledoc """
  ...
  - `Raxol.Earn.Wallet.SCA.BundlerHarnessTest` (the original caller
    -- it inlines this logic; eventually moves over)
  - `Raxol.Earn.ProviderAdapter.JSONRPCTest`
  - `Raxol.Earn.HookClientLiveTest`
  ...
  ## Usage
      ...
      defmodule MyTest do
        ...
        setup_all do
          %{rpc: Raxol.Earn.Test.AnvilHarness.start!(port: 8601)}
        end
  ...
  three are exposed as `anvil_account/1`:
      ...
      Raxol.Earn.Test.AnvilHarness.anvil_account(0)
