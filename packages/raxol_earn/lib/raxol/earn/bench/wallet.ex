defmodule Raxol.Earn.Bench.Wallet do
  @moduledoc """
  Wallet used by `mix raxol_earn.bench` to sign memos during the
  in-memory benchmark.
  ...
  set, so a fresh checkout can run `mix raxol_earn.bench` with no
  setup.
  ...
  `Raxol.Earn.ProviderAdapter.Mock`.
  """
