defmodule Raxol.Earn.JobSession.Status do
  @moduledoc """
  ...
  action transitions into. Returns `nil` for unknown actions.
      ...
      iex> Raxol.Earn.JobSession.Status.target_status(:set_budget)
      :budget_set

      iex> Raxol.Earn.JobSession.Status.target_status(:reject)
      :rejected
  """
