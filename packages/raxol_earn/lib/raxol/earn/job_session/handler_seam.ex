defmodule Raxol.Earn.JobSession.HandlerSeam do
  @moduledoc """
  ...
  - `:deliver` -> `c:Raxol.Earn.Offering.Handler.handle_deliver/2` once the
    job is funded (before `submit`).
  - `:evaluate` -> `c:Raxol.Earn.Offering.Handler.handle_evaluate/2` when the
  ...
  @type ctx :: Raxol.Earn.Offering.Handler.ctx()
