defmodule Raxol.Earn.JobSession.Tools do
  @moduledoc """
  ...
  *minimum* gated set; raxol may surface `:send_message` more liberally
  ...
  Check whether the role may invoke this action at this status.
      ...
      iex> Raxol.Earn.JobSession.Tools.allowed?(:provider, :funded, :submit)
      true

      iex> Raxol.Earn.JobSession.Tools.allowed?(:client, :submitted, :complete)
      false
  """
