defmodule Raxol.Earn.Console.Inference do
  @moduledoc """
  LLM seam for `Raxol.Earn.Console.Generator`.
  ...
  billing. Configure with:
      ...
      config :raxol_earn, :console_inference,
        module: Raxol.Earn.Console.Inference.Compute,
  ...
  `config :raxol_earn, :console_inference_static` verbatim.
  """
  ...
  def config do
    Keyword.merge(
      ...
      Application.get_env(:raxol_earn, :console_inference, [])
    )
  end
  ...
  defmodule Compute do
    ...
    @behaviour Raxol.Earn.Console.Inference
  ...
  defmodule Static do
    @moduledoc "Test stub: returns `config :raxol_earn, :console_inference_static`."
    @behaviour Raxol.Earn.Console.Inference

    @impl true
    def complete(_cfg, _system, _user) do
      case Application.get_env(:raxol_earn, :console_inference_static) do
