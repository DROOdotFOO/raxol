defmodule Raxol.Earn.Console.AgentOffering do
  @moduledoc """
  ...
  - `handle_request/2` — fail-closed pre-escrow gate: `Spec.validate/1`
    ...
    error, fail closed).
  - `handle_deliver/2` — delegates to `Raxol.Earn.Console.Delivery.run/2`
  ...
  `mix earn.register_offering --offering console`.
  """
  ...
  alias Raxol.Earn.Console.{BenchSlots, Delivery, Spec}
