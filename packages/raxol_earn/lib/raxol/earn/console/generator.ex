defmodule Raxol.Earn.Console.Generator do
  @moduledoc """
  Turns a validated `Raxol.Earn.Console.Spec` into a Console agent package.

  One structured inference call (through `Raxol.Earn.Console.Inference`) returns
  ...
  alias Raxol.Earn.Console.{Inference, Spec}
