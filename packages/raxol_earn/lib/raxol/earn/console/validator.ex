defmodule Raxol.Earn.Console.Validator do
  @moduledoc """
  ...
  `config :raxol_earn, :console_soul_bytes, {min, max}` (default `{50, 40_000}`).
  ...
  defp run(:soul, files, _tasks) do
    {min, max} = Application.get_env(:raxol_earn, :console_soul_bytes, {50, 40_000})
