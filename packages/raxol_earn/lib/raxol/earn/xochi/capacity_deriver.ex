defmodule Raxol.Earn.Xochi.CapacityDeriver do
  @moduledoc """
  Reads the Xochi/Riddler solver's on-chain token balances and projects them into
  offering caps. Shared by the `raxol_earn.derive_caps` mix task (one-shot) and
  `Raxol.Earn.Xochi.CapacityRefresher` (periodic, at runtime).
  ...
  `Raxol.Earn.Xochi.CapacityLedger.load/2` (aggregate) and the `:destination_caps`
