defmodule Raxol.Earn.Xochi.CapacityRefresher do
  @moduledoc """
  Periodically re-derives per-destination capacity from the solver's live
  on-chain balances and loads it into `Raxol.Earn.Xochi.CapacityLedger`, so the
  ...
  `Raxol.Earn.Xochi.CapacityDeriver.capacity_map/1`, one `balanceOf` per corridor)
  ...
  alias Raxol.Earn.Xochi.{CapacityDeriver, CapacityLedger}
