defmodule Raxol.Earn.Event do
  ...
  @type payload :: %{
          ...
          optional(:budget) => Raxol.Earn.AssetToken.t(),
          optional(:transfer_amount) => Raxol.Earn.AssetToken.t(),
  ...
  key.
      ...
      iex> Raxol.Earn.Event.decode_type("job.created")
      {:ok, :job_created}

      iex> Raxol.Earn.Event.decode_type("nope")
