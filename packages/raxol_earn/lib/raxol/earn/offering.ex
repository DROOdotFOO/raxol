defmodule Raxol.Earn.Offering do
  @moduledoc """
  ...
  - `@behaviour Raxol.Earn.Offering` (for the schema callbacks)
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      """
      @spec spec() :: Raxol.Earn.Offering.Registry.Spec.t()
      def spec do
        %Raxol.Earn.Offering.Registry.Spec{
          name: @offering_name,
          handler: __MODULE__,
      ...
      @doc """
      Register this offering with `Raxol.Earn.Offering.Registry`.
      Returns the same `{:ok, spec} | {:error, term}` as
      `Registry.register/1`.
      """
      @spec register() :: {:ok, Raxol.Earn.Offering.Registry.Spec.t()} | {:error, term()}
      def register, do: Raxol.Earn.Offering.Registry.register(spec())
