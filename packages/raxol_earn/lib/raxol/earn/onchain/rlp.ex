defmodule Raxol.Earn.Onchain.Rlp do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Raxol.Earn.Onchain.Rlp.encode(0)
      <<0x80>>

      iex> Raxol.Earn.Onchain.Rlp.encode("dog")
      <<0x83, "d", "o", "g">>

      iex> Raxol.Earn.Onchain.Rlp.encode(["cat", "dog"])
      <<0xc8, 0x83, "c", "a", "t", 0x83, "d", "o", "g">>

      iex> Raxol.Earn.Onchain.Rlp.encode([])
      <<0xc0>>
  """
