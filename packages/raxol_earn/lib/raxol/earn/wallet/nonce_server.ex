defmodule Raxol.Earn.Wallet.NonceServer do
  @moduledoc """
  ...
  The default-named instance (`Raxol.Earn.Wallet.NonceServer`) is started
  by `Raxol.Earn.Supervisor` for the umbrella seller wallet.
  """
