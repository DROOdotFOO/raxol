defmodule Raxol.Earn.Wallet.SCA.UserOp do
  @moduledoc """
  ...
  defp decode_address!(hex) when is_binary(hex) and byte_size(hex) == 40 do
    case Base.decode16(hex, case: :mixed) do
      ...
      _ -> raise ArgumentError, "Raxol.Earn.Wallet.SCA.UserOp: invalid address #{inspect(hex)}"
    end
  end

  defp decode_address!(other) do
    raise ArgumentError, "Raxol.Earn.Wallet.SCA.UserOp: invalid address #{inspect(other)}"
  end
end
