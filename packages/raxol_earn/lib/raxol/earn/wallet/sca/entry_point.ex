defmodule Raxol.Earn.Wallet.SCA.EntryPoint do
  @moduledoc """
  ...
  `Raxol.Earn.Wallet.SCA.ModularAccount.nonce_key/3`); the low 64 bits are
  the sequence the EntryPoint maintains.

  Extracted so the `Raxol.Earn.ProviderAdapter.SCA` and
  `Raxol.Earn.Wallet.SCA.Provisioner` write paths query nonces the same
  way.
  """
