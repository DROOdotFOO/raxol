defmodule Raxol.Earn.Seller.Backend do
  @moduledoc """
  ...
  `:type` key. The `Raxol.Earn.Seller.Queue` is the canonical consumer
  ...
  `Raxol.Earn.Seller.Runtime` can subscribe to them by referring to the
  module:

      Raxol.Earn.Seller.Backend.subscribe(impl_module, self())
