defmodule Raxol.Earn.Seller.Backend.InMemory do
  @moduledoc """
  In-process implementation of `Raxol.Earn.Seller.Backend`.
  ...
  driving end-to-end seller flows in tests and in `mix raxol_earn.bench`.
  ...
  no subscribers.
  """
  @spec publish(Raxol.Earn.Seller.Backend.event()) :: :ok
