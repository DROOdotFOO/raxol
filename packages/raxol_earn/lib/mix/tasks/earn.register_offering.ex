defmodule Mix.Tasks.Earn.RegisterOffering do
  @moduledoc """
  ...
  ## Usage
      ...
      mix earn.register_offering                     # usdc_public, stdout
      mix earn.register_offering --offering stealth
      mix earn.register_offering --pretty --out offering.json
  ...
  alias Raxol.Earn.Xochi.Offering
  ...
  defp offering_metadata(:console) do
    %{
      name: Raxol.Earn.Console.AgentOffering.offering_name(),
      description:
      ...
      price_usdc: Decimal.to_float(Raxol.Earn.Console.AgentOffering.price_usdc()),
      price_type: "fixed",
      sla_minutes: Raxol.Earn.Console.AgentOffering.sla_minutes(),
      required_funds: false,
      requirement_schema: Raxol.Earn.Console.Spec.requirement_schema()
    }
  end
