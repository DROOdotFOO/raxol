defmodule Raxol.Property.ParserTest do
  ...
  describe "parser property tests" do
    ...
    # superlinear blowup is caught by size instead, in
    # test/property/core_property_test.exs ("parsing 200k characters stays
    # linear enough to finish", budgeted by the test's own timeout);
    # `bench/` owns the parser's actual budget (<3us/char, enforced by the
    # regression workflow).
  end
