defmodule Raxol.Property.ParserEdgeCasesTest do
  ...
  describe "performance stress tests" do
    ...
    # ceiling around `Parser.parse/1`. The parser's budget is enforced for
    # real by `bench/` and the regression workflow (`<3us/char`); in the
    # suite these are totality properties -- the parse of any alternation or
    # mixed-content sequence returns a token list rather than raising,
    # hanging or losing input.
    @tag :slow
