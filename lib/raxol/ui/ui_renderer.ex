  ...
  defp render_validated_element(valid_element, theme, parent_style) do
    ...
    case {width, height} do
      ...
      _ ->
        ...
        # modal-backdrop dimming: `:dim_behind_modal` is stamped by the
        # layout engine on every element an `:absolute_layer`'s flow
        # content produces while a dialog overlay is active.
        element_with_dims
