defmodule Raxol.Core.Renderer.View.Layout.Flex do
  ...
  # Validates a flex direction, raising if invalid. Retained for
  # container/1, which is still live (View DSL `flex` macro, consumed by
  # the production Raxol.UI.Layout.Engine pipeline).
