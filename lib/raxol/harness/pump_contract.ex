defmodule Raxol.Harness.PumpContract do
  ...
  **The one exception is resize**: `resize/2` builds a real
  ...
  | `{:approval_answer_result, result}` | fifo | pump, one per executed approval-answer directive | `:ok`: SILENT (the decision receipt folded from `approval_decided` is the record); error: dispatch-failure notice |
